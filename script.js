...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const login = () => {
        if(document.getElementById('access-password').value === CLAVE){ sessionStorage.setItem('acceso','true'); document.getElementById('login-screen').style.display='none'; document.getElementById('main-content').style.display='block'; }
        else { document.getElementById('login-error').classList.remove('hidden'); }
    };
    if(sessionStorage.getItem('acceso') === 'true'){ document.getElementById('login-screen').style.display='none'; document.getElementById('main-content').style.display='block'; }
    ...
    document.querySelectorAll('.tab-button-uds').forEach(btn => btn.onclick = () => {
        ...
        document.querySelectorAll('.uds-panel').forEach(p => { p.classList.add('hidden'); p.classList.remove('active'); });
        btn.classList.add('active'); const target = document.getElementById(`panel-uds-${btn.dataset.uds}`);
